...
k(arguments);return a.s*a.n*b.d===b.s*b.n*a.d};b.divisible=function(a){a=k(arguments);return 0===b.n*a.d%(a.n*b.d)};b.toString=function(){var a=(""+b.n).split(""),g=b.d,c=0,d="",h=q(b.n,b.d),e;a:{e=b.d;for(var f=0;f<e;f++)if(r(f,e)===r(f+h,e)){e=f;break a}e=0}for(var f=-1,k=10+h+e+a.length,m=0;m<k;m++){c*=10;m<a.length?c+=parseInt(a[m],10):m===a.length?(d+=".",f=0):f++;if(0<h&&f===e)d+="(";else if(0<h&&f-e===h){d+=")";break}c>=g?(d+=c/g|0,c%=g):d+="0"}return(~b.s?"":"-")+d.replace(/^0+([1-9]|0\.)/g,
