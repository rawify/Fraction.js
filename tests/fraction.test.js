...
describe('Fraction simplify', function () {
  ...
  it("Should work value of with large numbers", function () {
    var fraction = new Fraction(
      -,
      
    );
    assert.equal(fraction.valueOf(), -444.5189263379361);
  });
});
